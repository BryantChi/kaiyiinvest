        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="icon" class="form-label">圖標 Class</label>
                        <input type="text"
                        ...
                        <div class="form-text">FontAwesome 或 CoreUI 圖標 class</div>
                        @error('icon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>

                    <div class="mb-3" id="icon-preview">
                        <label class="form-label">圖標預覽</label>
                        <div class="p-3 bg-light rounded text-center">
                            <i id="icon-display" class="{{ old('icon', $category->icon ?? 'fas fa-folder') }}" style="font-size: 2rem; color: {{ old('color', $category->color ?? '#6c757d') }}"></i>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    colorInput.addEventListener('input', function() {
        ...
        iconDisplay.style.color = this.value;
    });

    // 圖標預覽
    const iconInput = document.getElementById('icon');
    iconInput.addEventListener('input', function() {
        iconDisplay.className = this.value || 'fas fa-folder';
    });
